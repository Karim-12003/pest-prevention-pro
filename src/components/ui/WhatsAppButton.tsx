...
const WhatsAppButton = ({
  ...
  const variantStyles = {
    default: "bg-green-600 text-white hover:bg-green-700 rounded-md shadow-sm",
    outline: "border border-green-600 text-green-600 hover:bg-green-600/10 rounded-md",
    ghost: "text-green-600 hover:bg-green-600/10 rounded-md",
    link: "text-green-600 underline-offset-4 hover:underline",
    fixed: "fixed bottom-24 right-6 z-50 bg-green-600 text-white shadow-lg rounded-full hover:scale-105 active:scale-95 transition-transform"
  };
