      ...
      <div className="container mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-8">
          ...
          <p className="section-subheading mb-0">
            Erfahren Sie, was unsere Kunden über unsere Schädlingsbekämpfungsdienste in <span data-city>{cityName}</span> sagen.
          </p>
        </div>
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 review-location">
                      {review.location || <span data-city>{cityName}</span>}
                    </p>
                  </div>
                </div>
        ...
        <div className="text-center mt-10 md:mt-16">
          <div className="bg-white rounded-xl p-4 md:p-6 inline-block shadow-sm border border-primary/10">
            ...
            <p className="text-sm text-muted-foreground">
              Basierend auf über 487 verifizierten Bewertungen in <span data-city>{cityName}</span> auf ProvenExpert
            </p>
          </div>
        </div>
      </div>
