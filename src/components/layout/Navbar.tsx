...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <header
        className={cn(
          'fixed top-[36px] md:top-[48px] left-0 right-0 z-40 transition-all duration-300 py-2 md:py-4',
            ...
            <div className="flex items-center">
              ...
              <div className="text-primary font-bold text-xl md:text-2xl lg:text-3xl transition-all ml-2 md:ml-3">
                <div className="flex flex-col sm:flex-row items-start sm:items-center">
                  <span className="text-[#9b87f5] whitespace-nowrap leading-tight text-sm sm:text-2xl md:text-2xl">Kammerjäger</span>
                  <span className="font-light whitespace-nowrap ml-0 sm:ml-2 leading-tight text-sm sm:text-2xl md:text-2xl">Adalbert</span>
                </div>
              </div>
            </div>
